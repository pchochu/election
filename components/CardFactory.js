...
import { Button, Card, Icon, Message, Grid, Popup } from 'semantic-ui-react'
...
class CardFactory extends Component{
    ...
    publishResults = async (event) => {
      ...
      renderCard() {
        if(this.props.address['isCreated'] == 'finished_no_uploaded'){
        ...
        } else if(this.props.address['isCreated'] == 'created_with_keys'){
            return   <Message info>
                        <Message.Header>Volby prebiehajú</Message.Header>
